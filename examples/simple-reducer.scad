/**
 * SIMPLE REDUCER ADAPTER
 * Simple reducer for general use
 */

use <../matrixflow.scad>

/* [General Dimensions] */
transition_height = 5; // [10:500]
wall_thickness = 2.0; // [0.4:10]
curve_tension = 0.35; // [0.1:0.05:2.0]
smoothness = 30; // [20:200]
fn = 64; // [32:256]

/* [Top Shape (Output)] */
top_shape = "circle"; // [circle, rectangle]
top_width = 110; // [10:500]
top_depth = 110; // [10:500]
...
bottom_width = 120; // [10:500]
bottom_depth = 120; // [10:500]
